<footer class="bg-surface-100-800-token h-80">
	<div
		class="max-w-2xl container flex flex-col justify-center items-center h-full mx-auto text-center"
	>
		<svg
